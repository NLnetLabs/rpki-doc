...
`RFC 6810 <https://tools.ietf.org/html/rfc6810>`_ (v0) and `RFC 8210
<https://tools.ietf.org/html/rfc8210>`_ (v1). Is it specifically designed to
deliver validated prefix origin data to routers. This, as well as origin
validation functionality, is currently available in on various hardware
...
based on the result. Relying party software such as :ref:`doc_routinator` can
export validated data in a format that OpenBGPD can parse.
