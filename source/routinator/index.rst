...
Routinator is free, open source RPKI Relying Party software written in the
Rust programming language. It is designed to be lightweight and have great
...
<https://github.com/NLnetLabs/routinator/issues>`_. We are also happy to
accept your pull requests. For general discussion and exchanging operational
experiences we provide a `mailing list
<https://nlnetlabs.nl/mailman/listinfo/rpki>`_. This is also the place where
we will announce releases of the application and updates on the project.
