...
certfication authorities (CAs) starting with those referred to in the configured
TALs.
...
VRPs that have address prefixes overlapping with resources of rejected CAs are
called *unsafe VRPs*.
